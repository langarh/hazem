...
@ExtendWith(MockitoExtension.class)
 ...
 class FournisseurServiceMockTest {
   ...
   @Mock
   private FournisseurRepository fournisseurRepository; // Add this

   @Mock
   private DetailFournisseurRepository detailFournisseurRepository; // Add this

   private IFournisseurService fournisseurService;
   @BeforeEach
   public void setUp() {
      // Create a mock FournisseurRepository
      FournisseurRepository fournisseurRepository = Mockito.mock(FournisseurRepository.class);

      // Create a mock DetailFournisseurRepository
      DetailFournisseurRepository mockDetailFournisseurRepository = Mockito.mock(DetailFournisseurRepository.class);

      // Create an instance of FournisseurServiceImpl and inject the mock repositories
      fournisseurService = new FournisseurServiceImpl(fournisseurRepository, mockDetailFournisseurRepository);
   }
   ...
   @Test
    void testRetrieveAllFournisseurs() {
      ...
      Mockito.when(fournisseurService.retrieveAllFournisseurs()).thenReturn(fournisseurs);
   ...
   @Test
    void testAddFournisseur() {
      ...
      // Create an instance of FournisseurServiceImpl and inject the mock repository
      IFournisseurService fournisseurService = new FournisseurServiceImpl(fournisseurRepository, detailFournisseurRepository);
