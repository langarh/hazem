...
public class FournisseurServiceImpl implements IFournisseurService {
	...
	public FournisseurServiceImpl(FournisseurRepository fournisseurRepository, DetailFournisseurRepository mockDetailFournisseurRepository) {
		this.fournisseurRepository = fournisseurRepository;
		this.detailFournisseurRepository = mockDetailFournisseurRepository;
	}
